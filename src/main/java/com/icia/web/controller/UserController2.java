...
public class UserController2
{
   ...
   public Response<Object> updateProc2(HttpServletRequest request, HttpServletResponse response)
   {
     ...
     * 고객센터
      ...
      public String customerCenter(ModelMap model, HttpServletRequest request, HttpServletResponse response)
      {
        ...
        * 관리자 센터
        ...
        @RequestMapping(value = "/user/findIdForm", method = RequestMethod.POST)
      	public String findId(HttpServletResponse response, @RequestParam("e_mail")
      			String userEmail2, Model model) throws Exception{
      		
      		model.addAttribute("userId2", userService2.findId(response, userEmail2));
    ...
    ///////////////////////////////////////////////
        ...
        public String findPwd(ModelMap model, HttpServletRequest request, HttpServletResponse response) {
        ...
        @RequestMapping(value="/user/findPwdForm", method=RequestMethod.POST)
        ...
        public String findPwdForm(HttpServletRequest request, HttpServletResponse response)
        {
           ...
           if(!StringUtil.isEmpty(userId2) && !StringUtil.isEmpty(userEmail2)) 
           {
              if(userService2.findPwd(userId2, userEmail2) == null) //값이 없다.
              {
                 // 존재하지 않는 정보
           ...
           else if (StringUtil.isEmpty(userId2) || StringUtil.isEmpty(userEmail2)) {
        	   ajaxResponse.setResponse(-1, "빈칸을 채워주세요");
        	   return "/user/userSearch";
           }
           ...
           if(logger.isDebugEnabled())
           {
              logger.debug("[UserController2] /user/findPwd response\n" + JsonUtil.toJsonPretty(ajaxResponse));
           }
//           
           return "/user/findPwdForm";
        }
